...
namespace NegativeScreen
{
	...
	public static class BuiltinMatrices
	{
		...
		public static float[,] CombineMatrices(params float[][,] matrices)
		{
		...
		public static float[,] ApplyBrightnessContrast(float[,] baseMatrix, float brightness, float contrast)
		{
			float[,] brightnessMatrix = CreateBrightnessMatrix(brightness);
			float[,] contrastMatrix = CreateContrastMatrix(contrast);
			return CombineMatrices(contrastMatrix, brightnessMatrix, baseMatrix);
		}
	}
